...
records = torch.load(evidence / "tiny-peagle-forwards.pt", weights_only=True)
model = LlamaForCausalLMPeagle(
    PeagleConfig.from_pretrained(root / "tiny-peagle/draft-original")
)
...
for record in records:
    ...
    (evidence / "tiny-peagle-decode-parity.json").write_text(
